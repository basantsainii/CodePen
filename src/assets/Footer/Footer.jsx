...
function Footer() {
  return (
    <>
      <div className='px-8 py-8 md:flex justify-between flex-wrap gap-5 bg-black'> 
        <div className="">
            <div className='flex gap-16 sm:block'>
            <ul className='block  sm:flex gap-3 text-white text-[0.9rem]'>
                <li className=''>CodePen</li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">About</a></li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">Blog</a></li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">PodCast</a></li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">Documentation</a></li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">Support</a></li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">Advertise</a></li>
            </ul>
            <ul className='block  sm:flex gap-3 text-white text-[0.9rem]'>
                <li className=''>For</li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">Teams</a></li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">Education</a></li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">Privacy</a></li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">Embeds</a></li>
                <li className='text-gray-600 hover:text-gray-300'><a href="">Asset Hosting</a></li>
            </ul>
            </div>
